...
char * buildCmd(char* cmd, char* cmdContent){
  	...
  	char* res = (char *)malloc(sizeof(cmd) + sizeof(cmdContent) + 2);
...
int main(int argc, char *argv[])
{
    ...
    unsigned char *username = (unsigned char *)malloc(sizeof(unsigned char));
    unsigned char *path = (unsigned char *)malloc(sizeof(unsigned char));
    unsigned char *password = (unsigned char *)malloc(sizeof(unsigned char));
    unsigned char *hostname = (unsigned char *)malloc(sizeof(unsigned char));
    unsigned char *filename = (unsigned char *)malloc(sizeof(unsigned char));
